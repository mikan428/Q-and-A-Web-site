# Generated by Django 3.0.4 on 2020-05-12 14:32
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('ampapp', '0065_occulta_occultine_occultq'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hobbyq', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='ampapp.Hobbyq')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='ユーザー')),
            ],
            options={
