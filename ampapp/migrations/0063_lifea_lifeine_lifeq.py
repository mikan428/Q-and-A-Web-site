# Generated by Django 3.0.4 on 2020-05-12 12:14
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('ampapp', '0062_healtha_healthine_healthq'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lifeq', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='ampapp.Lifeq')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='ユーザー')),
            ],
            options={
