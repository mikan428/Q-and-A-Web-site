# Generated by Django 3.0.4 on 2020-05-12 02:12
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('ampapp', '0058_auto_20200510_2207'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scienceq', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='ampapp.Scienceq')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='ユーザー')),
            ],
            options={
                'verbose_name_plural': 'Investa',
            },
        ),
    ]
